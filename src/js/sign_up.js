...
function registerUser() {
  ...
  var user_bachelors_degree_college_name = bachelors_degree_college_name
    .trim()
    .replace("'", "''");
  ...
  if (masters_degree_college_name !== "") {
    user_masters_degree_college_name = masters_degree_college_name
      .trim()
      .replace("'", "''");
  } else {
    ...
    success: function (response) {
      if (response.includes("Username already exists")) {
        failed_modal_message_para.innerHTML =
          "<strong>This email is already registered with us. </strong>";
        ...
        failed_modal_message_para.innerHTML =
          "<strong>Registration was not successful </strong>";
        $("#failed_modal").modal("show");
        ...
        failed_modal_message_para.innerHTML =
          "<strong> Registration failed.Sorry! Please try again later</strong>";
        $("#failed_modal").modal("show");
